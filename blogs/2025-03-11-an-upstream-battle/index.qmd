...
![](images/an-upstream-battle.png){fig-align="left" width="70%"}
...
### Colors:
For my color palette, I chose a variety of shades of blue and reddish-pink. The blue represents water and the river that is critical habitat for the salmon. The pink is inspired by Chinook salmon males, which often take on a reddish-pink hue during spawning, though I must say that my hot pink is a bit exaggerated. I wanted to make sure that my visualization was accessible to people with color-blindness, so  also ensured that the color hues and saturation that I chose were colorblind-friendly.
