...
**2)  How has the abundance of winter-run Chinook salmon changed over time?** (spoiler: They're now on the endangered species list)

**3) How do river water temperatures influence winter-run Chinook salmon spawning?**
