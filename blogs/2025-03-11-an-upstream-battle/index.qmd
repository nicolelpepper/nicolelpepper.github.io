...
![](images/an-upstream-battle.png){fig-align="center" width="100%"}
...
```
![](outputs/habitat-map.png){fig-align="center" width="100%"}
...
```
![](outputs/pop-plot.png){fig-align="center" width="100%"}
...
```
![](outputs/habitat-plot.png){fig-align="center" width="100%"}
...
```
![](outputs/population-plot.png){fig-align="center" width="100%"}
...
```
![](outputs/heatmap.png){fig-align="center" width="100%"}
...
```
![](outputs/temp-prop-plot.png){fig-align="center" width="100%"}
